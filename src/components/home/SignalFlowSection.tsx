...
const modules: SignalModule[] = [
  {
    ...
    subtitle: 'Central command interface for WiFi hotspot infrastructure and real-time network monitoring.',
    icon: <Eye className="w-7 h-7" />,
    color: '#FF6A00',
    glowColor: 'rgba(255, 106, 0, 0.15)',
    satellites: [
      { icon: <Server className="w-4 h-4" />, label: 'Hotspots', stat: '1.2K' },
      { icon: <Globe className="w-4 h-4" />, label: 'Sites', stat: '42' },
      { icon: <BarChart3 className="w-4 h-4" />, label: 'Uptime', stat: '99.99%' },
      { icon: <AlertTriangle className="w-4 h-4" />, label: 'Alerts', stat: 'Healthy' },
    ],
    stats: [
      { label: 'Active Users', value: '47.3K' },
  ...
  },
  {
    ...
    subtitle: 'Integrated payment processing with mobile money, vouchers, and comprehensive revenue tracking.',
    icon: <TrendingUp className="w-7 h-7" />,
    color: '#00D9FF',
    glowColor: 'rgba(0, 217, 255, 0.15)',
    satellites: [
      { icon: <TrendingUp className="w-4 h-4" />, label: 'Revenue', stat: '+24%' },
      { icon: <Cpu className="w-4 h-4" />, label: 'Payments', stat: 'Secure' },
      { icon: <BarChart3 className="w-4 h-4" />, label: 'Failed', stat: '0.04%' },
      { icon: <Network className="w-4 h-4" />, label: 'Gateways', stat: '12' },
    ],
    stats: [
      { label: 'Daily Revenue', value: '$24K' },
      { label: 'Mobile Payments', value: '89%' },
    ],
  },
  {
    id: 'vouchers',
    ...
    subtitle: 'Advanced voucher generation, distribution, and redemption with multi-format support.',
    icon: <Zap className="w-7 h-7" />,
    color: '#22C55E',
    glowColor: 'rgba(34, 197, 94, 0.15)',
    satellites: [
      { icon: <Zap className="w-4 h-4" />, label: 'Gen Speed', stat: '5K/s' },
    ...
    stats: [
      { label: 'Generated Today', value: '14.2K' },
      { label: 'Active Vouchers', value: '98.4K' },
    ],
  },
  {
    id: 'devices',
    ...
    subtitle: 'Seamless management of Mikrotik, TP-Link, Unifi, and Ruijie devices with RADIUS support.',
    icon: <Expand className="w-7 h-7" />,
    color: '#A855F7',
    glowColor: 'rgba(168, 85, 247, 0.15)',
    satellites: [
      { icon: <Server className="w-4 h-4" />, label: 'Mikrotik', stat: 'Live' },
      { icon: <Globe className="w-4 h-4" />, label: 'TP-Link', stat: 'Active' },
      { icon: <Eye className="w-4 h-4" />, label: 'Unifi', stat: 'Monitored' },
      { icon: <Shield className="w-4 h-4" />, label: 'Ruijie', stat: 'Synced' },
    ],
    stats: [
  ...
  },
  {
    ...
    subtitle: 'Intelligent automatic reconnection handling power outages, signal loss, and user mobility.',
    icon: <Shield className="w-7 h-7" />,
    color: '#E63946',
    glowColor: 'rgba(230, 57, 70, 0.15)',
    satellites: [
      { icon: <Lock className="w-4 h-4" />, label: 'Power Loss', stat: '<5s' },
      { icon: <Shield className="w-4 h-4" />, label: 'Signal Recovery', stat: 'Auto' },
      { icon: <Expand className="w-4 h-4" />, label: 'Mobility', stat: 'Seamless' },
      { icon: <AlertTriangle className="w-4 h-4" />, label: 'Success Rate', stat: '99.7%' },
    ],
    stats: [
      { label: 'Reconnections Today', value: '142K' },
      { label: 'Avg Recovery Time', value: '3.2s' },
    ],
  },
];
